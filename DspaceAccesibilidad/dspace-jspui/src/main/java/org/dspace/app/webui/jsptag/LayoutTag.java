...
/*    
 ...
 Fecha : 02-nov-2014, 22:36:21
 Author  : http://www.dspace.org/license
 Modificado por : Antonio Paternina
 Descripciòn : Se agregan las reeferencias y funciones para poder cargar el archivo 'scriptfutco.js'
               y 'cssfutco.css'
 */
 ...
 * <li><code>dspace.layout.feeddata</code> - <code>String</code>. "NONE" means
 * no feed from this page; otherwise the Handle of object (community or
 * collection) the feed is from</li>
 * <li><code>dspace.layout.linkparts</code> - <code>String[]</code>. A cycling
 * sequence of: 2nd part of MIME type (e.g. <code>rdf+rss</code>); title of
 * feed; path component to go after /feed/ for the actual feed URL (e.g.
 * <code>rss_1.0</code>). Hence, this array will have 3<i>n</i>
 ...
 * <p>
 * <ul>
 * <li><code>dspace.layout.head</code> - extra data to include verbatim in the
 * &lt;head&gt; element of the page</li>
 * </ul>
 *
...
public class LayoutTag extends BodyTagSupport {
    ...
    /**
     * Atributos para almacenar el css cssfutco.css y el script scriptfutco.js*
     */
    ...
    public int doStartTag() throws JspException {
        ...
        /*Se comprueban es estado de las variables, sino se alamcena la referenecia en ellas*/
...
// Sort out location bar
     ...
     *
     * @param v Value to assign to feedData.
     */
