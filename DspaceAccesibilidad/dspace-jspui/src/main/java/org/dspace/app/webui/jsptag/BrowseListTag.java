        ...
        */
        ...
        try
        {
            ...
            if (widthArr.length > 0 && widthArr.length == fieldArr.length && !linkToEdit)
            {
                ...
                {
                    out.println("<table style=\"width: " + tablewidth + "; table-layout: fixed;\" align=\"center\" class=\"table\" summary=\"En esta tabla se navega por todos los contenidos dspace\">");
                }
                else
                {
                    // Otherwise, don't constrain the width
                    out.println("<table align=\"center\" class=\"table\" summary=\"En esta tabla se navega por todos los contenidos dspace\">");
                }
            ...
            {
                out.println("<table width=\"" + tablewidth + "\" align=\"center\" class=\"table\" summary=\"En esta tabla se navega por todos los contenidos dspace\">");
            }
            else
            {
                out.println("<table align=\"center\" class=\"table\" summary=\"En esta tabla se navega por todos los contenidos dspace\">");
