     ...
     <form name="loginform" class="form-horizontal" id="loginform" method="post" action="<%= request.getContextPath() %>/password-login">  
	  ...
	  <p><fmt:message key="jsp.components.login-form.enter"/></p>
		<div class="form-group">
            ...
            <div class="col-md-3">
            	<input class="form-control" type="text" name="login_email" id="tlogin_email" tabindex="" />
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-3">
            	<input class="form-control" type="password" name="login_password" id="tlogin_password" tabindex="" />
            </div>
        </div>
        <div class="row">
        <div class="col-md-6">
        	<input tabindex=""  type="submit" class="btn btn-success pull-right" name="login_submit" value="<fmt:message key="jsp.components.login-form.login"/>" />
        </div>
        </div>
