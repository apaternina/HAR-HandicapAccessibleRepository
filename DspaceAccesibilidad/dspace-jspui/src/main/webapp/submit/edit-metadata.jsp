...
Fecha : 11-nov-2014, 08:10
Author  : http://www.dspace.org/license
Modificado por : Antonio Paternina - apaternina
Descripciòn : Se modifican etiquetas para que mostraran correcto algunosmnombres de campo en idioma español.
--%>
...
<%!
    ...
    void doTextArea(javax.servlet.jsp.JspWriter out, Item item,
        ...
        if (fieldName.equals("dc_description_abstract")) {
            id_fieldFor = "dc_description_abstract_id";
        }
        if (fieldName.equals("dc_description_sponsorship")) {
            id_fieldFor = "dc_description_sponsorship_id";
        }
        if (fieldName.equals("dc_description")) {
            id_fieldFor = "dc_description_id";
        }
    ...
    void doOneBox(javax.servlet.jsp.JspWriter out, Item item,
        ...
        if (label.equals("Publisher") || label.equals("Editor")) {
            id_field = "dc_publisher";
        } else if (label.equals("Other Titles") || label.equals("Otros títulos")) {
            id_field = "dc_title_alternative";
        } else if (label.equals("Citation") || label.equals("Citación")) {
            id_field = "dc_identifier_citation";
        } else if (label.equals("Título") || label.equals("Title")) {
            id_field = "dc_title";
        }
    ...
    void doDropDown(javax.servlet.jsp.JspWriter out, Item item,
        ...
        if (label.equals("Type")) {
            id_field = "select_tipo";
        } else if (label.equals("Language")) {
            id_field = "select_lenguaje";
        }
        sb.append("<div class=\"row\"><label for='" + id_field + "' class=\"col-md-2" + (required ? " label-required" : "") + "\">");
        sb.append(label)
                .append("</label>");
